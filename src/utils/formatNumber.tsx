...
function formatNumber(
    ...
    if (round) value = Math.round(value * Math.pow(10, precision)) / Math.pow(10, precision);
    const formatNumb = formatNumberToLocaleStandard(value, Math.max(precision, 0)) + (unite ?? "");
